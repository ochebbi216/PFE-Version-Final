...
@Component({
  selector: 'app-listpasserelleuser',
  templateUrl: './listpasserelleuser.component.html',
  styleUrls: ['./listpasserelleuser.component.css']
})
export class ListpasserelleuserComponent implements OnInit {
  ...
  firstname: string;
  lastname: string;
  constructor(public endpoint: EndpointService , private actRoute: ActivatedRoute , private datas: PasserelleDataService, private router: Router, public authService: AuthService) {
...
passerelle: any = {
  ...
  // getdata(Nom:string,Description:string,nomUtilisateur:string,GPSLong:number,GPSLat:number,Sensor1:number,Date:Date,id:String){
