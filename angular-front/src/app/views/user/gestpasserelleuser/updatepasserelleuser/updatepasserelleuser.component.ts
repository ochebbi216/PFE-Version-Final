...
@Component({
  selector: 'app-updatepasserelleuser',
  templateUrl: './updatepasserelleuser.component.html',
  styleUrls: ['./updatepasserelleuser.component.css']
})
export class UpdatepasserelleuserComponent implements OnInit {
  submitted = false;
  editForm: FormGroup;
    ...
    if (!this.editForm.valid) {
      return false;
        ...
        this.apiService.update(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/user/listpasserelle');
