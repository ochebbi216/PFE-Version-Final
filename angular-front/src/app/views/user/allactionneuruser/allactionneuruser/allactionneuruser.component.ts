...
@Component({
  selector: 'app-allactionneuruser',
  templateUrl: './allactionneuruser.component.html',
  styleUrls: ['./allactionneuruser.component.css']
})
export class AllactionneuruserComponent implements OnInit {
